...
def main():
    ...
    goal_1_2 = PoseStamped()
    goal_1_2.header.frame_id = "base"

    #x, y, and z position
    goal_1_2.pose.position.x = 0.5
    goal_1_2.pose.position.y = 0.0
    goal_1_2.pose.position.z = 0.0

    #Orientation as a quaternion
    goal_1_2.pose.orientation.x = 0.0
    goal_1_2.pose.orientation.y = 0.0
    goal_1_2.pose.orientation.z = 0.0
    goal_1_2.pose.orientation.w = 1.0
    # planner.add_box_obstacle(np.array([0.40,1.20,0.10]),'table', goal_1_2)
    ...
    # orien_const.absolute_x_axis_tolerance = 5;
    # orien_const.absolute_y_axis_tolerance = 5;
    # orien_const.absolute_z_axis_tolerance = 5;
